      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="bg-white rounded-lg shadow-lg p-8 sm:p-12">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Bienvenue sur la page À propos de notre application Next.js. Cette
            page est entièrement responsive et s'adapte à tous les appareils.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Créer des expériences web modernes et accessibles pour tous les
                utilisateurs.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Next.js, React, TypeScript et Tailwind CSS pour un développement
                efficace.
              </p>
            </div>
          </div>
